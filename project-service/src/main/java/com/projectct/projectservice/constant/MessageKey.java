package com.projectct.projectservice.constant;

public class MessageKey {
    public static final String PROJECT_CREATE_SUCCESS = "project.create.success";
    public static final String PROJECT_CREATE_DUPLICATE = "project.create.duplicate";
    public static final String PROJECT_NOT_FOUND = "project.not.found";
    public static final String PROJECT_UPDATE_SUCCESS = "project.update.success";
    public static final String PROJECT_DELETE_SUCCESS = "project.delete.success";
    public static final String PROJECT_NAME_INVALID = "project.name.invalid";
    public static final String TASK_NOT_FOUND = "task.not.found";
    public static final String TASK_CREATE_SUCCESS = "task.create.success";
